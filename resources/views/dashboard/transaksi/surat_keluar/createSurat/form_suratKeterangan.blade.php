...
<div class="row selected-surat" id="surat-keterangan" aria-label="surat-keterangan">
    <div class="col-lg-7">
        <div class="card mt-4 card-input">
            <div class="card-body">
                <h3 class="mb-5">Surat Keterangan</h3>
                <form action="/transaksi/surat-keluar" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-4 mb-2 form-group">
                            ...
                            <input type="text" name="jenis_surat" class="form-control" value="Surat Keterangan" autocomplete="off" readonly>          
                        </div>
                    ...
                    <div class="row mb-5">
                        <div class="col-sm-8 form-group">
                            ...
                            <select class="form-select perihal_surat mb-2" name="perihal_surat" id="perihal_surat" aria-label="Select value" required>
                                ...
                                <option class="js_select_mahasiswa" value="Permohonan surat keterangan telah mengikuti KKP">(Mahasiswa) Permohonan surat keterangan telah mengikuti KKP </option>
                                <option class="js_select_mahasiswa" value="Permohonan surat keterangan telah mengikuti KPM">(Mahasiswa) Permohonan surat keterangan telah mengikuti KPM</option>
                                <option class="js_select_mahasiswa" value="Permohonan surat keterangan telah mengikuti Mahad">(Mahasiswa) Permohonan surat keterangan telah mengikuti Ma'had</option>
                                <option class="js_select_dosen" value="Permohonan surat keterangan telah submit Artikel">(Dosen) Permohonan surat keterangan telah submit Artikel</option>
                            </select>
                        </div>
                        <div class="col-sm-4 form-group">
                    ...
                    <div id="formulir" style="display: none">
                        ...
                        <div class="row mb-3 js_judul_artikel" id="js_judul_artikel" style="display: none">
                            <div class="col-sm-10 form-group">
                                <label for="judul_artikel"> Judul Artikel</label>
                                <input type="text" name="judul_artikel" class="form-control" id="judul_artikel" aria-describedby="judul_artikel" autocomplete="off" required>
                            </div>
                        </div>
