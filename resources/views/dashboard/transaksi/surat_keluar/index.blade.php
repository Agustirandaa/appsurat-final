    ...
    <div class="row gap-2">
        ...
        <div class="col">
            <div class="d-flex justify-content-end">
                <a href="/transaksi/surat-keluar/create" role="button" class="btn btn-light fw-bolder"> Tambah 
                ...
                <td class="py-2 px-4">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="{{ route('edit-surat-keluar', ['slug' => $data->slug, 'jenis' => $data->jenis_surat, 'status' => $data->status ]) }}">
                                    <i class='btn btn-success bi bi-pencil'></i>
                                </a>
                            </li>
                            
                            <li>
                                <button type="button" class="dropdown-item deletedModalSuratKeluar" data-slug="/transaksi/surat-keluar/{{ $data->slug }}" data-nomor="{{ $data->nomor_surat }}">
