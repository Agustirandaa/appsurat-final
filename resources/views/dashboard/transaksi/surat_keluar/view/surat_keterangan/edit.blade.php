                ...
                <form action="/transaksi/surat-keluar/{{ $surat->slug }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-10 form-group">
                            ...
                            <input type="text" name="judul_artikel" value="{{ $surat->suratketerangan->judul_artikel }}" class="form-control" id="judul_artikel" aria-describedby="judul_artikel" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="row mb-5">
                        <div class="col-sm-10 form-group">
                            ...
                            <textarea type="text" name="body_surat" class="form-control" aria-describedby="body_surat" rows="5" autocomplete="off" required>{{ $surat->suratketerangan->body_surat }}</textarea>      
                        </div>
                    </div>          
